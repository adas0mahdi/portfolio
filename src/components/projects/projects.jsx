...
const Projects = () => {
  return (
    <div id="projects" className="container projects-container">
      <h1 className="project-txt">PROJRCTS</h1>
      <div className="project ">
        ...
        <div className="project-info">
          ...
          <a href="https://github.com/adas0mahdi/CineZone.git" className="contact-project">
            <span>Project</span>
          </a>
        </div>
      </div>
      <div className="project ">
        <div className="project-img img-g"></div>
        <div className="project-info">
      ...
      <div className="project ">
        <div className="project-img img-b"></div>
        <div className="project-info">
          <h1 className="name">HotelResponsive</h1>
          <h3 className="languageUsed">HTML, CSS</h3>
          <h4 className="about">
          Unleash luxury with HotelResponsive! Discover captivating design, seamless navigation, and exclusive accommodations. Book your dream stay, indulge in exceptional service, and create unforgettable memories at every moment. Elevate your travel experience today!
          </h4>
          <a href="https://github.com/adas0mahdi/03_HotelResponsive.git" className="contact-project">
            <span>Project</span>
          </a>
        </div>
      </div>
      <div className="project ">
        <div className="project-img img-c"></div>
        <div className="project-info">
      ...
      <div className="project ">
        <div className="project-img img-d"></div>
        <div className="project-info">
      ...
      <div className="project ">
        <div className="project-img img-e"></div>
        <div className="project-info">
      ...
      <div className="project ">
        <div className="project-img img-f"></div>
        <div className="project-info">
      ...
      <div className="project ">
        <div className="project-img img-h"></div>
        <div className="project-info">
